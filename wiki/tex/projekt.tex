...
Z~wymagań funkcjonalnych wynika, że wykresy muszą współpracować z~dwoma typami źródeł danych:
\begin{itemize}
\item{serie danych}
\item{modele z architektury Model-Widok}

W~szczególności ważna jest współpraca z~popularnym w~Qt~Quick modelem -- \textit{QQmlListModel}.

Aby ułatwić ułatwić programistom rozpoczęcie współpracy z~moją biblioteką, zdecydowałem się zastosować statyczny polimorfizm przy projektowaniu serii danych.
