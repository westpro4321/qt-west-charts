...
Biblioteką odpowiedzialną za testy w~Qt jest QtTestLib~\cite{qttest}. Biblioteka ta udostępnia narzędzia umożliwiające tworzenie, m.in. testów jednostkowych, testów starowanych danymi oraz testów wydajnościowych. Jako, że do testowania mojej biblioteki wykorzystam właśnie tę platformę, poniżej opisuję pokrótce jej możliwości. Następnie opisuję sposób i~zakres testów, które zostaną przeprowadzone na mojej bibliotece.
